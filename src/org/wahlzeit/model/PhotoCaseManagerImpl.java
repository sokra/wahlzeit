 ...
 *
 */
public class PhotoCaseManagerImpl extends ObjectManager implements Lifecycle, Saveable, PhotoCaseManager {
	 ...
	 */
	@Inject
	protected PhotoCaseManagerImpl(SysLog sysLog, Provider<Session> contextProvider) {
